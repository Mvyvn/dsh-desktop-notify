...
// /dnotify 向 host 上报页面聚焦状态（协议与 @deepseek-ai/dsh-client-connection
// 的 createWebConnectionRpc 相同）。
//
  ...
  factory: function (require) {
    ...
    function report(forced) {
      try {
        ...
        rpcCall('/dnotify', 'page-focus', { focused: focused, pageId: getPageId() }).catch(function () {})
      } catch (e) { /* ignore */ }
    }
