...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    exports.apply = function apply(ctx) {
      ...
      report()
      openEventStream()
      handleHashTarget()   // 旧式 hash 深链（点击通知已改走 /dnotify/click + SSE）
    }
